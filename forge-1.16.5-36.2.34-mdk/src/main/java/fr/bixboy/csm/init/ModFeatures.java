...
public class ModFeatures {
    ...
    public void init()
    {
        ...
        ORE_COPPER_FEATURE = register("ore_amethyst", Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, ModBlocks.COPPER_ORE.get().defaultBlockState(), 9))
                .squared()
                .range(23)
                .count(25));
    }
    ...
    public void biomeLoading(BiomeLoadingEvent e)
    {
        ...
        if(e.getCategory() != Biome.Category.NETHER)
        {
            ...
            generation.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, ORE_COPPER_FEATURE);
        }
    }
}
