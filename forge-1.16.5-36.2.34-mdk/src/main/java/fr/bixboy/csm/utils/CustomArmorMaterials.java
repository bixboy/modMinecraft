...
public enum CustomArmorMaterials implements IArmorMaterial {
    ...
    AMETHYST_AMOR(CSM.MODID + ":amethyst", 18, new int[]{2, 5, 7, 3}, 11, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.0f, 0.0f, () -> {
    ...
    private CustomArmorMaterials(String p_i231593_3_, int p_i231593_4_, int[] p_i231593_5_, int p_i231593_6_, SoundEvent p_i231593_7_, float p_i231593_8_, float p_i231593_9_, Supplier<Ingredient> p_i231593_10_) {
